...
void TitleBar::initControl() {
	...
	//设置对象名
	m_pTitleContent->setObjectName("TitleContent");//标题栏内容
	...
	m_pTitleContent->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Fixed);//标题内容的尺寸策略，就和我们现在正在使用应用一样（水平可以扩展，垂直方向固定）
