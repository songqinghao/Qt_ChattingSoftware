...
void TalkWindowShell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TalkWindowShell *_t = static_cast<TalkWindowShell *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject TalkWindowShell::staticMetaObject = {
    { &BasicWindow::staticMetaObject, qt_meta_stringdata_TalkWindowShell.data,
      qt_meta_data_TalkWindowShell,  qt_static_metacall, nullptr, nullptr}
};
