...
public:
    ...
    void setupUi(QWidget *EmotionWindow)
    {
        ...
        buttomWidget = new QWidget(EmotionWindow);
        buttomWidget->setObjectName(QStringLiteral("buttomWidget"));
        QSizePolicy sizePolicy2(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(buttomWidget->sizePolicy().hasHeightForWidth());
        buttomWidget->setSizePolicy(sizePolicy2);
        verticalLayout_2 = new QVBoxLayout(buttomWidget);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setContentsMargins(11, 11, 11, 11);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        scrollArea = new QScrollArea(buttomWidget);
        ...
        verticalLayout_3->addWidget(buttomWidget);
